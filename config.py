...
flags.DEFINE_integer('monte_carlo_simulations', 10, 'The number of monte carlo simulation runs')
flags.DEFINE_integer('reload_step', 11000, 'Reload step to continue training')
...
flags.DEFINE_integer('start_channel_num', 8, 'start number of outputs for the first conv layer')
